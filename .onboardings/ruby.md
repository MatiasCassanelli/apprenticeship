...
- [ ] Follow [Basic Ruby](https://www.theodinproject.com/courses/ruby-programming#basic-ruby) to learn about Ruby primitives, Ruby built-in methods, iterators and flow control
